...
class PortalUserPolicy
{
    ...
    {
        return $user->can('delete_portal::user');
    }
    ...
    {
        return $user->can('delete_any_portal::user');
    }
    ...
    {
        return $user->can('force_delete_portal::user');
    }
    ...
    {
        return $user->can('force_delete_any_portal::user');
    }
    ...
    {
        return $user->can('restore_portal::user');
    }
    ...
    {
        return $user->can('restore_any_portal::user');
    }
    ...
    {
        return $user->can('replicate_portal::user');
    }
    ...
    {
        return $user->can('reorder_portal::user');
    }
}
